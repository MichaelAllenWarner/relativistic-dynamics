...
Light is an electromagnetic wave---a disturbance in the (Lorenz-gauge) four-potential field $\vv A = \vv A (\vv R)$ that propagates through free space (where the four-current-density field $\vv J = \vv J (\vv R)$ is zero). To discuss it mathematically, then, means working with solutions to the homogeneous wave equation
\begin{equation*}
